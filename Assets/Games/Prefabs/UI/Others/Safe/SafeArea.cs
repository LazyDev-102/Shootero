...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        public enum SimDevice
        {
            ...
            Pixel3XL_LSR,
            /// <summary>
            /// Simulate the iPhone X and 11 (identical safe areas).
            /// </summary>
            iPhoneXR,
        }
        ...
        /// <summary>
        /// Normalised safe areas for iPhone XR an iPhone 11 with Home indicator. Absolute values:
        ///  PortraitU x=0, y=68, w=828, h=1636 on full extents w=828, h=1792;
        ///  PortraitD x=0, y=68, w=828, h=1636 on full extents w=828, h=1792 (not supported, remains in Portrait Up);
        ///  LandscapeL x=88, y=42, w=1616, h=786 on full extents w=1792, h=828;
        ///  LandscapeR x=88, y=42, w=1616, h=786 on full extents w=1792, h=828.
        ///  Aspect Ratio: ~19.5:9.
        /// </summary>
        Rect[] NSA_iPhoneXR = new Rect[]
        {
            new Rect (0f, 68f / 1792f, 1f, 1636f / 1792f),  // Portrait
            new Rect (132f / 1792f, 42f / 828f, 1616f / 1792f, 786f / 828f)  // Landscape
        };
        #endregion
        ...
        bool IsIPhoneXRAnd11() {
            return Screen.width == 828 && Screen.height == 1792;
        }
    }
}
