...
public class MB11Skill02AttackComponent : MinibossAttackComponent<MB11Attack> {
    ...
    private IEnumerator IShotting() {
        ...
        int damage = minibossAttack.MB11Base.MB11Stat.Atk.Value;
        ...
        for (int i = 0; i < numberShot; ++i) {
            ...
            if (newBullet) {
                newBullet.SetInfor(damageCircle, damageLine, minibossAttack.MB11Base);
