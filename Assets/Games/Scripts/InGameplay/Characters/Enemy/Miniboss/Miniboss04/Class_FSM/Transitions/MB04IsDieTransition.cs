...
public class MB04IsDieTransition : MB04Transition {

    #region Singleton
    public MB04IsDieTransition() {

    }
    private static MB04IsDieTransition instance = null;
    public static MB04IsDieTransition Instance {
        get {
            if (instance == null) {
                instance = new MB04IsDieTransition();
            }
            return instance;
        }
    }
    ...
    public override bool CheckTransition(StateController<MB04Base> controller) {
        ...
        if (isTransition) {
            controller.TransitionToState(MB04DeadState.Instance, this);
        }
        return isTransition;
    }
