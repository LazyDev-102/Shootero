...
public class MB01Skill01AttackComponent : MinibossAttackComponent<MB01Attack> {
    ...
    public override void Updating() {
        minibossAttack.MB01Base.MB01Move.LookDirection(UnityHelper.Down);
    }
    ...
    public override void StartAttack() {
        atk = (int)(minibossAttack.MB01Base.MB01Stat.Atk.Value * damagePercent);
    }

    public T ChangingBullet<T>(T bullet) where T : BulletBase {
        bullet.SetHitInfor(atk, null, minibossAttack.MB01Base);
        return bullet;
    }
