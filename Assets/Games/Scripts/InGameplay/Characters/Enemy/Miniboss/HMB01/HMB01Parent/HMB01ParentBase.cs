...
[RequireComponent(typeof(MinibossStat), typeof(MinibossHealth), typeof(HMB01ParentAttack))]
[RequireComponent(typeof(MinibossMove), typeof(MinibossHitbox))]
[RequireComponent(typeof(MinibossSkill), typeof(HMB01ParentStateController))]
public class HMB01ParentBase : MinibossBase {
    #region References

    private HMB01ParentAttack mb09ParentAttack;
    public HMB01ParentAttack HMB01ParentAttack {
        get {
            if (mb09ParentAttack == null) {
                mb09ParentAttack = EnemyAttack as HMB01ParentAttack;
            }
