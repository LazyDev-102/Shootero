...
public class B13Attack3State : B13State {

    #region Singleton
    public B13Attack3State() {

    }
    private static B13Attack3State instance = null;
    public static B13Attack3State Instance {
        get {
            if (instance == null) {
                instance = new B13Attack3State();
            }
            return instance;
        }
    }
