...
public class B06Attack1State : B06State {

    #region Singleton
    public B06Attack1State() {

    }
    private static B06Attack1State instance = null;
    public static B06Attack1State Instance {
        get {
            if (instance == null) {
                instance = new B06Attack1State();
            }
            return instance;
        }
    }
