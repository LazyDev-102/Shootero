...
public class B01AppearCompleteTransition : B01Transition {
    #region Singleton
    public B01AppearCompleteTransition() {

    }
    private static B01AppearCompleteTransition instance = null;
    public static B01AppearCompleteTransition Instance {
        get {
            if(instance == null) {
                instance = new B01AppearCompleteTransition();
            }
            return instance;
        }
    }
