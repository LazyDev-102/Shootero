...
public class B14Attack1State : B14State {

    #region Singleton
    public B14Attack1State() {

    }
    private static B14Attack1State instance = null;
    public static B14Attack1State Instance {
        get {
            if (instance == null) {
                instance = new B14Attack1State();
            }
            return instance;
        }
    }
