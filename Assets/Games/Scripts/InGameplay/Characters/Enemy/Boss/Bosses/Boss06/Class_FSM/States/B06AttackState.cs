...
public class B06AttackState : B06State {

    #region Singleton
    public B06AttackState() {

    }
    private static B06AttackState instance = null;
    public static B06AttackState Instance {
        get {
            if (instance == null) {
                instance = new B06AttackState();
            }
            return instance;
        }
    }
