...
public class B05AttackState : B05State {

    #region Singleton
    public B05AttackState() {

    }
    private static B05AttackState instance = null;
    public static B05AttackState Instance {
        get {
            if (instance == null) {
                instance = new B05AttackState();
            }
            return instance;
        }
    }
