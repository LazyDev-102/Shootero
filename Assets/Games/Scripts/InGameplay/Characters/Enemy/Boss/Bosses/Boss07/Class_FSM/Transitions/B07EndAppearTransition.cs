...
public class B07EndAppearTransition : B07Transition {
    #region Singleton
    public B07EndAppearTransition() {

    }
    private static B07EndAppearTransition instance = null;
    public static B07EndAppearTransition Instance {
        get {
            if (instance == null) {
                instance = new B07EndAppearTransition();
            }
            return instance;
        }
    }
