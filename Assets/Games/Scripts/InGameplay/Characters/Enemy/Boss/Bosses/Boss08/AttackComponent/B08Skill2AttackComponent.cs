...
public class B08Skill2AttackComponent : BossSkillAttackComponent {
    ...
    [SerializeField] private ME02B08Base miniEnemyPrefab;
    ...
    public override void Attacking() {
        ...
        ME02B08Base newMELeft = miniEnemyPrefab.Spawn(transform.position);
        newMELeft.SetInfo(hp, atk);
        newMELeft.ME02B08Attack.SetShotDuration(attackData.Duration);
        newMELeft.ME02B08Move.SetTargetPosition(BorderHelper.GetWorldPointInsideArea(leftArea));
        newMELeft.ME02B08Move.SetRotateSpeed(rotateSpeed);
        newMELeft.Initialize();
        newMELeft.AddOnEndBossAttack(EnemyComplete);
        enemyInited++;

        ME02B08Base newMERight = miniEnemyPrefab.Spawn(transform.position);
        newMERight.SetInfo(hp, atk);
        newMERight.ME02B08Attack.SetShotDuration(attackData.Duration);
        newMERight.ME02B08Move.SetTargetPosition(BorderHelper.GetWorldPointInsideArea(rightArea));
        newMERight.ME02B08Move.SetRotateSpeed(-1 * rotateSpeed);
