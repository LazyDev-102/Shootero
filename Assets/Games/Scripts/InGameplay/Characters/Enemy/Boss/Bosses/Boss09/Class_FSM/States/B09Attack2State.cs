...
public class B09Attack2State : B09State {

    #region Singleton
    public B09Attack2State() {

    }
    private static B09Attack2State instance = null;
    public static B09Attack2State Instance {
        get {
            if (instance == null) {
                instance = new B09Attack2State();
            }
            return instance;
        }
    }
