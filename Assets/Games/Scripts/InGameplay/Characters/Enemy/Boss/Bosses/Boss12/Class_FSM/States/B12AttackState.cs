...
public class B12AttackState : B12State {

    #region Singleton
    public B12AttackState() {

    }
    private static B12AttackState instance = null;
    public static B12AttackState Instance {
        get {
            if (instance == null) {
                instance = new B12AttackState();
            }
            return instance;
        }
    }
