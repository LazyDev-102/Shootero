...
public class B05Skill3AttackComponent : BossSkillAttackComponent {
    ...
    [SerializeField, Range(0, 180)] private float angleEnd = 30;
    [SerializeField, Range(0, 180)] private float angleStart = 0;
    ...
    private void InitAngleBullet() {
        ...
        bullet2.transform.localEulerAngles = temp;
