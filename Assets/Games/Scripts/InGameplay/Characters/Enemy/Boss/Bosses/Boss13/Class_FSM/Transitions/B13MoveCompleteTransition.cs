...
public class B13MoveCompleteTransition : B13Transition {
    #region Singleton
    public B13MoveCompleteTransition() {

    }
    private static B13MoveCompleteTransition instance = null;
    public static B13MoveCompleteTransition Instance {
        get {
            if (instance == null) {
                instance = new B13MoveCompleteTransition();
            }
            return instance;
        }
    }
