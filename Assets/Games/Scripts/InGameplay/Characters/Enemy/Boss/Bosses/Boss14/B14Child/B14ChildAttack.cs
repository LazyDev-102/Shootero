...
public class B14ChildAttack : BossAttack {
    ...
    public B14ChildBase B14ChildBase {
        get {
            if (mb15ChildBase == null) {
                mb15ChildBase = BossBase as B14ChildBase;
            }
            ...
            if (isShooting) {
                ...
                foreach (var gun in guns) {
                    if (deltaShotCountdowner.IsTimeOut()) {
                        gun.SetInfor(B14ChildBase.B14ChildStat.Atk.Value, null);
                        gun.Beaming(true);
                        deltaShotCountdowner.StartCountdown(deltaShot);
                    }
                    else {
    ...
    private void EndBeamLaser() {
        ...
        B14ChildBase.B14ChildMove.StartMoveAfterAttack();
