...
public class B04EndAttackTransition : B04Transition {
    #region Singleton
    public B04EndAttackTransition() {

    }
    private static B04EndAttackTransition instance = null;
    public static B04EndAttackTransition Instance {
        get {
            if (instance == null) {
                instance = new B04EndAttackTransition();
            }
            return instance;
        }
    }
