...
public class B14Attack3State : B14State {

    #region Singleton
    public B14Attack3State() {

    }
    private static B14Attack3State instance = null;
    public static B14Attack3State Instance {
        get {
            if (instance == null) {
                instance = new B14Attack3State();
            }
            return instance;
        }
    }
