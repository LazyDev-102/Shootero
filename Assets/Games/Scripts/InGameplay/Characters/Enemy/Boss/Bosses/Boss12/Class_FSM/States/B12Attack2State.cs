...
public class B12Attack2State : B12State {

    #region Singleton
    public B12Attack2State() {

    }
    private static B12Attack2State instance = null;
    public static B12Attack2State Instance {
        get {
            if (instance == null) {
                instance = new B12Attack2State();
            }
            return instance;
        }
    }
