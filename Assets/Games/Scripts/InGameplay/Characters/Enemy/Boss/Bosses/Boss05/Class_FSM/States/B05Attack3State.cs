...
public class B05Attack3State : B05State {

    #region Singleton
    public B05Attack3State() {

    }
    private static B05Attack3State instance = null;
    public static B05Attack3State Instance {
        get {
            if (instance == null) {
                instance = new B05Attack3State();
            }
            return instance;
        }
    }
