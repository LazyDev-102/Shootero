...
public class B11Attack1State : B11State {

    #region Singleton
    public B11Attack1State() {

    }
    private static B11Attack1State instance = null;
    public static B11Attack1State Instance {
        get {
            if (instance == null) {
                instance = new B11Attack1State();
            }
            return instance;
        }
    }
