...
public class ShotFrontPierceDoubleShipPattern : ShotFrontShipPattern {
    ...
    protected override void DoAttacking() {
        ...
        for (int ibullet = 0; ibullet < patternInfo.NumberBullet / 2; ++ibullet) {
            ...
            PierceFrontBullet goLeft = gameLoader.SpawnBullet(bulletPrefab, positionLeft);
            if (goLeft) {
            ...
            PierceFrontBullet goRight = gameLoader.SpawnBullet(bulletPrefab, positionRight);
            if (goRight) {
