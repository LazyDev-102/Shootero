...
public class UbhShotCtrl : UbhMonoBehaviour {
    ...
    protected UpdateStep m_updateStep;
    protected int m_nowIndex;
    protected float m_delayTimer;
    protected List<ShotInfo> m_randomShotList = new List<ShotInfo>(32);
    ...
    public virtual void SetBossAttack(BossAttack bossAttack) {
