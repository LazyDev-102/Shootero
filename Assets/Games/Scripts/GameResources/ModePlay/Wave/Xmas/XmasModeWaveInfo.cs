...
public class XmasModeWaveInfo : ConquerorWaveInfo { // softData
    private XmasModeWaveData xmasWaveData;
    private int limit;
    private int time;
    ...
    public XmasModeWaveData XmasWaveData { get => xmasWaveData; }
    ...
    public override void CreateData(int currentZoneIndex, int currentWaveIndex, ConquerorWaveData waveData) {
        ...
        this.xmasWaveData = waveData as XmasModeWaveData;
        this.currentWaveIndex = currentWaveIndex;
        ConfigModeWave configModeWaves = this.XmasWaveData.ConfigModeWaves;
        ...
        numberHItem = XmasWaveData.RangeXItem.GetRandomValue();
    }
    ...
    public override ConquerorWaveSpawner SetupSpawner(ConquerorWaveSpawner spawner) {
        if (spawner == null) {
            spawner = GameManager.Instance.GameLoader.Instantiate<XmasModeWaveSpawner>("Wave Spawner");
        }
        XmasModeWaveSpawner newSpawner = spawner.GetComponent<XmasModeWaveSpawner>();
        if (newSpawner == null) {
            newSpawner = spawner.gameObject.AddComponent<XmasModeWaveSpawner>();
        }
    ...
    public override float GetWaveMultipler() {
        return XmasWaveData.WaveMultipler;
    }

    public int GetBossId() {
        return RandomHelper.RandomInCollection(XmasWaveData.BossIds);
    }
    public int GetMiniBossId() {
        return RandomHelper.RandomInCollection(XmasWaveData.MinibossIds);
    }
