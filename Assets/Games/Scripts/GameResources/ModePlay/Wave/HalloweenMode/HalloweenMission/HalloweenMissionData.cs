...
[CreateAssetMenu(fileName = "HalloweenMissionData", menuName = "Resource/Modes/Halloween/HalloweenMissionData")]
public class HalloweenMissionData : ScriptableObject {
    [SerializeField] private List<HalloweenMissionItemData> datas;

    public List<HalloweenMissionItemData> Missions { get => datas; }
