...
[CreateAssetMenu(fileName = "GearHalloweenDrop", menuName = "Resource/HardData/Drop/Halloween/GearDrop")]
public class GearHalloweenModeDrop : BaseDrop {
    ...
    private void DropMaterial(Vector2 position) {
        ...
        if (newGearController) {
            newGearController.SetItem(itemRandom);
