...
[CreateAssetMenu(fileName = "ChipXmasDrop", menuName = "Resource/HardData/Drop/Xmas/ChipDrop")]
public class ChipXmasModeDrop : BaseDrop {
    ...
    private int GetChipInIcon(float XmasDifficultMultipler) {
        return Mathf.CeilToInt(5 * (0.8f + 0.2f * XmasDifficultMultipler));
    }
