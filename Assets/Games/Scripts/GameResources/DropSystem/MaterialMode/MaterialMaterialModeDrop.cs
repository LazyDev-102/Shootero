...
[CreateAssetMenu(fileName = "MaterialMaterialModeDrop", menuName = "Resource/HardData/Drop/MaterialMode/MaterialDrop")]
public class MaterialMaterialModeDrop : BaseDrop {
    ...
    private void DropMaterial(Vector2 position, int id, int amount) {
        Item itemRandom = RandomHelper.RandomInCollection(materialCollector.Items);
