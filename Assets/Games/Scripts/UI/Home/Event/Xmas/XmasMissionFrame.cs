...
public class XmasMissionFrame : MonoBehaviour, ILayout<XmasMissionItem, XmasMissionItemData>
{
    [SerializeField] private XmasMissionItem itemPrefab;
    [SerializeField] private Transform container;

    private XmasMissionData data;
    public List<XmasMissionItem> Items { get; set; } = new List<XmasMissionItem>();

    public void Initialize(XmasMissionData data) {
        this.data = data;
    }
