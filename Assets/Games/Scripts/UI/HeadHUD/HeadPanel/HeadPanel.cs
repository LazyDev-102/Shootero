...
public class HeadPanel : DOTweenFrame {
    [SerializeField] private SelectableCurrencyView[] currencyButtons;
    ...
    public Transform GetTargetCurrency(int id) {
        switch (id) {
            case ConstantItemID.ChipId:
                return currencyButtons[0].TargetUI;
            case ConstantItemID.GemId:
                return currencyButtons[1].TargetUI;
            case ConstantItemID.EnergyId:
                return currencyButtons[2].TargetUI;
            default:
                return currencyButtons[0].TargetUI;
        }
    }
