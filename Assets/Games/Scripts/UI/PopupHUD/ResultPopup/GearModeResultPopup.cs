...
public class GearModeResultPopup : BasePopup {
    ...
    private void GetReward() {
        GameResources.Instance.GearModeData.ClaimReward();
    }
    ...
    private void SetFrameGear() {
        var data = GameResources.Instance.GearModeData;
    ...
    public GearModeResultPopup SetWin(bool isWin) {
        this.isWin = isWin;
        StartCoroutine(PlayEffectHeader());
        GameResources.Instance.GearModeData.ChangeTurnRemain(isWin ? -1 : 0);
        return this;
    }
