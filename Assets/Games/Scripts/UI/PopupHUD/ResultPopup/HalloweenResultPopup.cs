...
public class HalloweenResultPopup : BasePopup {
    ...
    private void GetReward() {
        GameResources.Instance.Halloween.ClaimReward();
    }
    ...
    private void SetFrameGear() {
        var data = GameResources.Instance.Halloween;
    ...
    public HalloweenResultPopup SetWin(bool isWin) {
        this.isWin = isWin;
