...
public class ButtonBase : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler {
    ...
    protected const float ZoomOutTime = 0.1f;
    protected const float ZoomInTime = 0.1f;
    protected Vector3 originScale = new Vector3(1.0f, 1.0f, 1.0f);
